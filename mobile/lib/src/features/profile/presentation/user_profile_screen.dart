      ...
      try {
        ...
        if (context.mounted) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('${username ?? 'User'} has been $action')),
          );
        }
      } catch (e) {
        if (context.mounted) {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _StatItem(label: 'Check-ins', value: user.totalCheckins.toString()),
          _StatDivider(),
          _StatItem(label: 'Bands', value: user.uniqueBands.toString()),
          _StatDivider(),
          _StatItem(label: 'Venues', value: user.uniqueVenues.toString()),
          _StatDivider(),
          _StatItem(label: 'Badges', value: user.badgesCount.toString()),
        ],
      ),
    );
  }
